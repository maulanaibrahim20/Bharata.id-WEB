...
class ProductController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.pages.kelola.produk.index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('admin.pages.kelola.produk.create', $data);
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            return redirect('/admin/kelola/produk')->with('success', 'Succes Data Berhasil Ditambahkan!');
        } catch (\Exception $e) {
            DB::rollback();
    ...
    public function destroy($id)
    {
        try {
            ...
            return redirect('/admin/kelola/produk')->with('success', 'Succes Data Berhasil Dihapus!');
        } catch (\Exception $e) {
            DB::rollback();
