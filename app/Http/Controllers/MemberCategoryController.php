...
class MemberCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('member.pages.kelola.kategori.index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('member.pages.kelola.kategori.create', $data);
    }
    ...
    public function store(CreateCategoryRequest $request)
    {
        try {
            ...
            return redirect('/member/kelola/kategori');
        } catch (\Exception $e) {
            DB::rollback();
    ...
    public function edit($id)
    {
        ...
        return view('member.pages.kelola.kategori.update', $data);
    }
