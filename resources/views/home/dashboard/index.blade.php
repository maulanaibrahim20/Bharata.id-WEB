...
<div class="container mx-auto p-3">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-2 mt-4">
        <a href="" class="w-full p-4 bg-white border rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700 text-center">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mt-4" id="card-produk">
        ...
        <a href="{{ url('home/produk/'.$data->id) }}" class="w-full max-w-m p-3">
            <div>
                <img src="{{ url('foto_kost', $data->foto1) }}" class="h-auto max-w-full rounded-lg" alt="{{ $data->judul }}" />
            </div>
            <div class="mt-1">
            ...
            <div class="mt-1">
                ...
                <p class="text-sm font-normal font-semibold">{{$data->alamat_kost}}</p>
                <p class="text-sm font-normal text-gray-600">{{Str::limit($data->cerita_pemilik, 50)}}</p>
                <div>
                    <span class="text-lg font-normal  font-semibold">Rp{{$data->perbulan}}</span><span class="text-sm">/bulan</span>
                </div>
            </div>
        </a>
        @endforeach
