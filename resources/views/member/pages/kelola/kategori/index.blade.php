            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <a class="px-2 py-2 bg-blue-500 dark:bg-blue-600 rounded hover:bg-blue-600 dark:hover:bg-blue-700 text-white dark:text-black"
                        href="{{ url('/member/kelola/kategori/create') }}"><i class="bi bi-plus-square"></i></a>
                </div>
                <div>
                        ...
                        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400"
                            ...
                            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                <tr>
                                    ...
                                    <th class="px-6 py-3">image thumbnail</th>
                            ...
                            <tbody>
                                @foreach ($kategori as $data)
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                        ...
                                        <td class="px-6 py-4"><img src="{{ asset($data->imageHomeThumbnailUrl) }}"
                                                style="width:60px;height:60">
                                        </td>
                                        <td class="px-6 py-4 flex items-center gap-2">
                                            <a href="{{ url('member/kelola/kategori/' . $data->id . '/edit') }}"
                                            ...
                                            <div>
                                                <form id="deleteForm{{ $data->id }}"
                                                    action="{{ url('/member/kelola/kategori/' . $data->id) }}"
                                        ...
                                        <table
                                            ...
                                            <thead
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="px-6 py-3">Nama Slug</th>
                                                </tr>
                                            </thead>
                                            <tbody>
