    ...
    <div class="p-4 sm:ml-64">
        <div class="rounded-lg mt-14">
            <div class="bg-white rounded-lg shadow p-6">
                ...
                @endif
                <form action="{{ url('/member/kelola/kategori/' . $category->id) }}" enctype="multipart/form-data"
                    method="post" class="space-y-4 md:space-y-6 needs-validation" novalidate>
                    @csrf
                    @method('PUT')
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                for="validationCustom12">Gambar Saat ini </label>
                            <div class="flex justify-center items-center">
                                <img src="{{ asset($category->imageHomeThumbnailUrl) }}" class="border rounded w-80 h-80"
                                alt="Gambar Kategori">
                            </div>
                        </div>
                        <div>
                            <div class="mb-3">
                                ...
                                <input type="file"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 w-full px-1 py-1 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dropify"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="description" value="{{ $category->description }}"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 w-full px-1 py-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    id="validationCustom12" required>{{ old('description') }}</input>
                            </div>
                            <div class="mb-3">
                                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                    ...
                    <div class="flex items-center gap-2">
                        <a href="{{ url('/member/kelola/kategori') }}"
                            class="bg-blue-500 dark:bg-blue-600 text-gray-200 dark:text-gray-700 px-2 py-1 rounded">Back
                        </a>
                        <button
                            class="cursor-pointer bg-red-500 dark:bg-red-600 text-gray-200 dark:text-gray-700 px-2 py-1 rounded type="button">Delete</button>
                        <button
